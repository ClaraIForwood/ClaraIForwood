...
💡 Interests: Signal processing, AI/ML, software development, and game design
...
---
[![](https://visitcount.itsvg.in/api?id=ClaraIforwood&icon=0&color=0)](https://visitcount.itsvg.in)
...
🎮 Progressing on my side Unity game dev project, Crash Site
🤖 Experimenting with machine learning models and data visualization


🏆 Achievements

✨ Developed MATLAB analytical tool delivering measurable improvements for Airbus defense and space
⚙️ SolidWorks Certified Associate
...
🎯 Current Goal
 Complete dissertation on deep learning in financial services
